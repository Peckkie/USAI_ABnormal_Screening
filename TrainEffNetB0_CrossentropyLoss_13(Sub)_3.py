...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/dataframe_train_3.csv')
base_dir = '/media/tohn/SSD/Image/'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/dataframe_test_3.csv')
...
prediction_layer = layers.Dense(13, activation='softmax',name = 'prediction_layer')(dropout_layer_1)
...
root_logdir = '/media/tohn/SSD/ModelTrainByImage/R2/my_logsB0sub2_3'
def get_run_logdir():
    import time
...
model.save('./models/B0_R1_sub2_3.h5')