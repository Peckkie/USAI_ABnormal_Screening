...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R1_ANfocal_relu_2FC_3.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogsB5_ANfocal_2FC_relu_3_topconv'
def get_run_logdir():
    import time
...
model.save('./models/B5_R2topconv_ANfocal_2FC_3.h5')
