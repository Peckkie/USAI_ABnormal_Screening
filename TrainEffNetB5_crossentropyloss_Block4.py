...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R12.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_block42_B5'
def get_run_logdir():
    import time
...
model.save('./models/B5R2_block42.h5')
