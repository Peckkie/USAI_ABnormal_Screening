...
prediction_layer = layers.Dense(13, activation='softmax',name = 'prediction_layer')(dropout_layer_2)
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_1/mylogsB5_13sub_2FC_nonCrop_relu_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_13sub_relu_2FC_nonCrop_3.h5')