...
os.chdir('/media/tohn/SSD/ModelTrainByImages/R1_5')

root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_5/mylogsB5_15AB_1FC_relu_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_15AB_relu_1FC_fold5_3.h5')