...
root_logdir = '/media/tohn/SSD/unfreez_model/ResNet/my_logs_RNV250'
def get_run_logdir():
    import time
...
model.save('./models/RNV250_R1.h5')

#Unfreez
conv_base.trainable = True
set_trainable = False
for layer in conv_base.layers:
    if layer.name == 'conv5_block3_1_bn': #batch-normalization (BN) layers 
        set_trainable = True
    if set_trainable:
...
model.save('./models/RNV250_R2.h5')
