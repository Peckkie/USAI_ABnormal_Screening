...
base_dir = '/media/tohn/SSD/Image1/'
os.chdir(base_dir)
...
model_dir = '/media/tohn/SSD/ModelTrainByImage/R1_1/models/B5_R12.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImage/R1_2/my_logs_topconv2_B5'
def get_run_logdir():
    import time
...
model.save('./models/B5R2_blocktop_conv2.h5')
