...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R1_FP.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_topconv_5FP_1FC'
def get_run_logdir():
    import time
...
model.save('./models/B0R2_topconv_5FP_1FC.h5')
