...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B0_R1_FP2_relu_3FC.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_topconv_5FP_3FC'
def get_run_logdir():
    import time
...
model.save('./models/B0R2_topconv_5FP_3FC.h5')
