...
model_dir = '/media/tohn/SSD/ModelTrainByImage/R1_2/models/B0_R1.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImage/R2_2/my_logs_block4'
def get_run_logdir():
    import time
...
model.save('./models/B0R2_block4.h5')
