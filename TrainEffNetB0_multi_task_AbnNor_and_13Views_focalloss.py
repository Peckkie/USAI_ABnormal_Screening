...
loss_object = losses.CategoricalCrossentropy()#loss************
AbNorweight = 0.75
...
train_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_11views2/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_11views2/' + current_time + '/test'
...
model2.save('/media/tohn/SSD/ModelTrainByImage/multi_task/models/Nor_ABnor_b0_R2_multitask_13views_focal.h5')
