...
FC2 = layers.Dense(1000, activation='relu',name = 'FC2')(dropout_layer_2)
dropout_layer_3 = layers.Dropout(0.50,name = 'head_dropout_3')(FC2)
prediction_layer = layers.Dense(15, activation='softmax',name = 'prediction_layer')(dropout_layer_3)
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_1/mylogsB5_15AB_3FC_relu_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_15AB_relu_3FC_3.h5')