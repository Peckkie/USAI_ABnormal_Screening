...
# import data 
dataframe_train = pd.read_csv (r'/home/USAI/codes/USAI/traindf_fold1_3.csv')
dataframe_test = pd.read_csv (r'/home/USAI/codes/USAI/validationdf_fold1_3.csv')
...
EPOCHS = 200
batch_size = 16
model_dir = '/home/USAI/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R1_15AB_relu_2FC_3.h5'
...
prediction_layer2 = layers.Dense(5, activation='softmax',name = 'prediction_layer_2')(dropout_layer_2)
...
for layer in model2.layers:
    if layer.name == 'block4a_se_excite':
        set_trainable = True
    if set_trainable:
...
loss_object1 = losses.CategoricalCrossentropy()#loss************
...
train_log_dir = '/home/USAI/media/tohn/SSD/ModelTrainByImages/R2_1/mylogs_15AB_5FP_1FC_V2_1/' + current_time + '/train'
test_log_dir = '/home/USAI/media/tohn/SSD/ModelTrainByImages/R2_1/mylogs_15AB_5FP_1FC_V2_1/' + current_time + '/test'
...
#save model   
model2.save('/home/USAI/media/tohn/SSD/ModelTrainByImages/R2_1/models/NorAb_multitask_15AB_5FP_2FC_V2_1.h5')
