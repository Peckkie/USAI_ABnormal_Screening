...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R1_5FP_relu_2FC_3.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_topconv_5FP_2FC_3'
def get_run_logdir():
    import time
...
model.save('./models/B5R2_topconv_5FP_2FC_3.h5')
