...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B6_R1.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logsB6_topconv'
def get_run_logdir():
    import time
...
model.save('./models/B6R2_blocktop_conv.h5')
