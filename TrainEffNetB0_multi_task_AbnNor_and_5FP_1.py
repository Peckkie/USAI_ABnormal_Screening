...
train_generator = train_datagen.flow_from_dataframe(
        ...
        directory = train_dir,
        x_col = 'filename',
        y_col = ['Class_Normal','Class_Abnormal','Views_FP-A','Views_FP-B','Views_FP-C','Views_FP-D','Views_FP-E'],
...
def load_training_data():
    ...
    Y2 = np.column_stack((data[1][2], data[1][3], data[1][4], data[1][5], data[1][6]))
...
train_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_5FP1/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_5FP1/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImage/multi_task/models/NorABn_multitaskR2_5FP1.h5')
