...
prediction_layer = layers.Dense(5, activation='softmax',name = 'prediction_layer')(dropout_layer_3)
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_1/mylogsB5_5FP_3FC_relu_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_3FC_3.h5')