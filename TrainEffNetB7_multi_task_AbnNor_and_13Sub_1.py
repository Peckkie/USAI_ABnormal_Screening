...
train_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_13Sub1/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_13Sub1/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImages/R2_1/models/NorABn_multitaskR2_13views1.h5')