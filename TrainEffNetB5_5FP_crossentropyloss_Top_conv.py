...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B0_R1_FP2__relu_2FC.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_top_conv_5FP_2FC'
def get_run_logdir():
    import time
...
model.save('./models/B0R2_top_conv_5FP_2FC.h5')
