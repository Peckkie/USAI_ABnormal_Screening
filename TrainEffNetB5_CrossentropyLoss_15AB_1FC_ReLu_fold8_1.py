...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/Traindf_fold8.csv')
base_dir = '/media/tohn/SSD/Images/Image8'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')
#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/Validationdf_fold8.csv')
...
os.chdir('/media/tohn/SSD/ModelTrainByImages/R1_8')

root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_8/mylogsB5_15AB_1FC_relu_1'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_15AB_relu_1FC_fold8_1.h5')