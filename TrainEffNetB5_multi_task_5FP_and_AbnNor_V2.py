...
train_generator = train_datagen.flow_from_dataframe(
        ...
        directory = train_dir,
        x_col = 'filename',
        y_col = ['Views_FP-A','Views_FP-B','Views_FP-C','Views_FP-D','Views_FP-E','Class_Normal','Class_Abnormal'],
...
loss_object2 = BinaryFocalLoss(gamma=2)#loss************
AbNorweight = 0.75
...
def load_training_data():
    ...
    Y2 = np.column_stack((data[1][5], data[1][6]))
...
train_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogs_5FP_AN_2FC_1_v2/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogs_5FP_AN_2FC_1_v2/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImages/R2_1/models/5FP_multitask_5FP_AN_2FC_1_V2.h5')