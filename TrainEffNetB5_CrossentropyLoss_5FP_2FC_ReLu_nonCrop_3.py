...
prediction_layer = layers.Dense(5, activation='softmax',name = 'prediction_layer')(dropout_layer_2)
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_1/mylogsB5_5FP_2FC_relu_nonCrop_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_2FC_nonCrop_3.h5')