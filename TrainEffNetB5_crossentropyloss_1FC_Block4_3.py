...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R1_AN_relu_1FC_3.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogsB5_AN_1FC_relu_3_b4'
def get_run_logdir():
    import time
...
model.save('./models/B5_R2b4_AN_1FC_3.h5')
