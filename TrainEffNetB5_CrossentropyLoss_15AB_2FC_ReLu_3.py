...
prediction_layer = layers.Dense(15, activation='softmax',name = 'prediction_layer')(dropout_layer_2)
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_1/mylogsB5_15AB_2FC_relu_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_15AB_relu_2FC_3.h5')