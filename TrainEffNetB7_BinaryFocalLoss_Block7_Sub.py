...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B7_R1_sub.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logsB7suba7'
def get_run_logdir():
    import time
...
model.save('./models/B7_R2_b7_sub.h5')
