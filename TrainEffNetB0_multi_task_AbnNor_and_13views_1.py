...
train_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_13views1/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_13views1/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImage/multi_task/models/NorABn_multitaskR2_13views1.h5')