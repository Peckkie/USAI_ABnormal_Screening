...
os.chdir('/home/USAI/media/tohn/SSD/ModelTrainByImages/R1_3')

root_logdir = '/home/USAI/media/tohn/SSD/ModelTrainByImages/R1_3/mylogsB5_15AB_1FC_relu_2'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_15AB_relu_1FC_fold3_2.h5')