...
train_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogs_5FP_AN_2FC_1/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogs_5FP_AN_2FC_1/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImages/R2_1/models/5FP_multitask_5FP_AN_2FC_1.h5')