...
os.chdir('/media/tohn/SSD/ModelTrainByImages/R1_2')

root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_2/mylogsB5_AN_1FC_relu_3'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_AN_relu_1FC_3.h5')
