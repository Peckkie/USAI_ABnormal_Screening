...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B0_R1_sub2_relu_3FC.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_block42_5FP_13sub_3FC'
def get_run_logdir():
    import time
...
model.save('./models/B5R2_block4_13sub_3FC.h5')
