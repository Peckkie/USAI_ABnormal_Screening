...
epochs = 200
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/traindf_fold4_3.csv')
base_dir = '/media/tohn/SSD/Images/Image4'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/validationdf_fold4_3.csv')
...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_4/models/B5_R1_15AB_relu_1FC_fold4_3.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_4/my_logs_block5_15AB_1FC_3'
def get_run_logdir():
    import time
...
model.save('./models/B5R2b5_15AB_1FC_fold4_3.h5')
