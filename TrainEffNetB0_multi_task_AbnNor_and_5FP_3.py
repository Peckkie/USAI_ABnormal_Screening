...
for i in fpname:
    fpb = dataframe_test1[dataframe_test1['Views']== i]
    fpb1,fpb2 = 0,0
    abnnum,nornum = 0,0
    n1,n2 = 0,0
...
train_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_5FP3/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImage/multi_task/my_logs_5FP3/' + current_time + '/test'
...
model2.save('/media/tohn/SSD/ModelTrainByImage/multi_task/models/NorABn_multitaskR2_5FP3.h5')
