...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/traindf_fold1_2.csv')
base_dir = '/media/tohn/SSD/Images/Image1'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/validationdf_fold1_2.csv')
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_1/my_logsB72_2'
def get_run_logdir():
    import time
