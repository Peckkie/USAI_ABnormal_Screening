...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_3FC_focal_relu_R12.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/my_logs_topconv_B5_3FC'
def get_run_logdir():
    import time
...
model.save('./models/B5R2_blocktop_conv_3FC.h5')
